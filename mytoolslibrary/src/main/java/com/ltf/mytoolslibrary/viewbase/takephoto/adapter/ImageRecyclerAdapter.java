...
/**
 * 作者：李堂飞 on 2017/5/9 15:12
 * 邮箱：litangfei119@qq.com
 * 会出现明显的重新加载图片，可能是picasso图片加载框架的问题
 */
    ...
    private class CameraViewHolder extends ViewHolder{
        ...
        void bindCamera(){
            ...
            mItemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    CheckPermissionUtils.getSelectPicUpdateUtils().checkPermission(-1, mActivity, true, new CheckPermissionUtils.onBackPermissionResult() {
                        @Override
